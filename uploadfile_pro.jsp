        ...
        <table  cellspacing="0" cellpadding="0" align="center" border="0" class="body_content">          
            ...
            <tr>
                ...
                <td valign="top" style="border-left: dotted 1px darkgreen;height: 500px;width: 750px;">
                    <form action="UploadFilePro" method="post" enctype="multipart/form-data">
                        <table style="padding-left: 10px;" cellpadding="5" cellspacing="0" width="100%">
                            <tr>
                                <td>
                                    <h1>Upload Prohibited file </h1>
                                </td>
                            </tr>
                            <%                                            String msg = null;
                            ...
                            <tr>
                                <td>
                                    <input type="submit" name="btnsubmit" id="btnsubmit" value="Upload File" onclick="return checkform();" class="button"/>
