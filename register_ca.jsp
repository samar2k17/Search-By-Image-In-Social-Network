            ...
            <tr>
                ...
                <td width="950"  height="500" valign="top" style="padding-left: 10px;padding-right: 10px;">
                    <table style="padding-left: 10px;" cellpadding="5" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td valign="top">
                                <form action="register_ca" method="post">
                                    <table cellpadding="5" cellspacing="5" width="100%">
                                        ...
                                        <tr>                                            
                                            ...
                                            <td>
                                                <input type="text" name="txtfname" id="txtfname" class="inputbox" pattern="[A-Za-z]+" title="Only Characters are allowed"/>
                                            </td>  
                                            <td width="20%">
                                                <b>Last Name:</b>
                                            </td>
                                            <td>
                                                <input type="text" name="txtlname" id="txtlname" class="inputbox" pattern="[A-Za-z]+" title="Only Characters are allowed"/>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="email" name="txtemail" id="txtemail" class="inputbox" required/>
                                            </td>
                                            <td width="20%">
                                                <b>Contact No.:</b>
                                            </td>
                                            <td>
                                                <input type="number" name="txtcontno" id="txtcontno" class="inputbox" min="700000000" max="9999999999"  required/>
                                            </td>                                            
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="password" name="txtpwd" id="txtpwd"  class="inputbox"  required/>
                                            </td> 
                                            <td>
                                                <b>Retype&nbsp;Password:</b>
                                            </td>
                                            <td>
                                                <input type="password" name="txtcpwd" id="txtcpwd"  class="inputbox" required/>
                                            </td> 
                                        </tr>
                                        <tr>
                                            <td colspan="4">
