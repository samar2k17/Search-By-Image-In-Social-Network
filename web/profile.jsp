    ...
    <body>
        <table  cellspacing="0" cellpadding="0" align="center" border="0" class="body_content">          
            ...
            <center><table cellpadding="5" cellspacing="5"  >
                    ...
                    <form action="changeProfileImg" method="post" enctype="multipart/form-data">
                        <tr>
                        ...
                        <tr>  
                            <td>
                                <input type="submit" name="btnsubmit" id="btnsubmit" value="Change Image" onclick="return checkform();" class="button"/>
                            </td>
                        </tr>
                    </form>
