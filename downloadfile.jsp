                                    ...
                                    <table cellpadding="3" cellspacing="3" width="100%">
                                        ...
                                        <%
                                            ...
                                            try {
                                                ...
                                                String query = "SELECT id,filename,filepath,adding_date,status,fuserid FROM tblfiles WHERE userid='" + id + "'";
                                                ...
                                                while (result.next()) {
                                                    ...
                                                    String fuserid = result.getString("fuserid");
                                        ...
                                        <tr bgcolor="#f9f9f9">
                                            ...
                                            <td>
                                                   <%
                                              out.print("<a href='giveFeedback.jsp?fuserid=" + fuserid + "' title='Give Feedback'>" + caname + "</a>");
                                            %>
                                            </td>
                                            ...
                                            <td align="center">
                                                <a href="uploadFile?id=<%=fileid%>" class="cursor">Delete</a>
                                            </td>
